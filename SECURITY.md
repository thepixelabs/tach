...
- **Your own screenshots.** Your home directory is masked to `~/...` everywhere,
  including inside message bodies, but project names, session titles, branch
  names and model names are shown as they are. Check the frame before you post
  a screenshot.
