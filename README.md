...
Paths are masked to `~/...` throughout the UI and in exports, so a screenshot does not give away your username or directory layout. Project names, session titles, branch names and model names are shown as they are.
